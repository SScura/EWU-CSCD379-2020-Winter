...
namespace SecretSanta.Api.Controllers
{
    ...
    {
        protected Business.Services.IEntityService<TDto, TInputDto> Service { get; }

        protected BaseApiController(Business.Services.IEntityService<TDto, TInputDto> service)
        {
